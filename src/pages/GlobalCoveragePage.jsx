...
const JURISDICTIONS = [
  ...
  { code: "CR", name: "Costa Rica", region: "LATAM", taxId: "Cédula jurídica / NITE", documents: ["Cédula, DIMEX o pasaporte", "Constancia Hacienda", "Personería jurídica", "Beneficiarios"], creditBureau: "Equifax CR / CIC (SUGEF)", status: "coming_soon" },
  { code: "GT", name: "Guatemala", region: "LATAM", taxId: "NIT", documents: ["DPI o pasaporte", "Constancia RTU", "Patente", "Registro Mercantil"], creditBureau: "TransUnion Guatemala", status: "coming_soon" },
  { code: "HN", name: "Honduras", region: "LATAM", taxId: "RTN", documents: ["DNI o pasaporte", "Constancia SAR", "Escritura", "Representantes"], creditBureau: "TransUnion Honduras", status: "coming_soon" },
  { code: "SV", name: "El Salvador", region: "LATAM", taxId: "NIT / NRC", documents: ["DUI o pasaporte", "NIT digital", "Documentos CNR", "Representación"], creditBureau: "TransUnion El Salvador", status: "coming_soon" },
  { code: "DO", name: "Rep. Dominicana", region: "LATAM", taxId: "RNC", documents: ["Cédula o pasaporte", "Constancia DGII", "Registro Mercantil", "Beneficiarios"], creditBureau: "TransUnion RD (TuCrédito)", status: "coming_soon" },
