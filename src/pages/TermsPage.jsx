...
const sections = [
  ["1. Aceptacion de terminos", [
    "Al acceder y usar NEXUS Platform aceptas estos terminos. Si actuas por cuenta de una empresa, declaras tener facultades suficientes para obligarla.",
    "NEXUS puede actualizar estos terminos para reflejar cambios legales, operativos o tecnologicos. La version vigente estara disponible en la plataforma."
  ]],
  ["2. Descripcion del servicio", [
    "NEXUS Platform combina herramientas SaaS de cumplimiento, data room, revision documental, servicios profesionales NEXUS y flujos para solicitantes y otorgantes.",
  ...
  ["3. Documentos, expediente y data room", [
    ...
    "NEXUS puede revisar completitud, consistencia, formato, vigencia aparente y trazabilidad documental. NEXUS no garantiza la veracidad material de la informacion ni sustituye la debida diligencia de bancos, fondos, SOFOMES, fintechs, autoridades o asesores externos.",
  ...
  ["4. Uso de IA y resultados automatizados", [
    "NEXUS puede usar herramientas de IA, OCR, reglas de negocio o agentes automatizados para clasificar documentos, detectar faltantes, generar score preliminar, identificar inconsistencias y preparar observaciones.",
  ...
  ["5. Biometricos e identidad digital", [
    "Cuando se active el modulo biometrico, NEXUS podra integrar proveedores especializados para prueba de vida, validacion facial, comparacion contra identificacion oficial, huella digital u otras senales antifraude.",
    "La activacion de biometricos requerira consentimiento especifico y finalidades claras. NEXUS procurara guardar resultados, evidencias y bitacoras, no datos biometricos crudos salvo que sea necesario, legal y consentido."
  ]],
  ...
  ["8. Pagos, servicios profesionales y reembolsos", [
    ...
    "Los pagos se procesan mediante proveedores externos como Stripe. NEXUS no almacena datos completos de tarjeta.",
  ...
  ["9. Confidencialidad, retencion y eliminacion", [
    "NEXUS tratara la informacion como confidencial, salvo autorizacion del usuario, requerimiento legal, autoridad competente, auditoria, cumplimiento regulatorio o defensa de derechos.",
  ...
  ["10. Limitacion de responsabilidad", [
    "NEXUS no garantiza aprobacion de credito, inversion, fondeo, autorizacion regulatoria ni decision favorable de un otorgante.",
    "NEXUS no sera responsable por rechazos, cambios de criterio de entidades financieras, informacion falsa proporcionada por usuarios, fallas de terceros, fuerza mayor o decisiones tomadas sin revision profesional.",
    "En caso de detectar posible fraude, uso indebido o actividad ilicita, NEXUS podra suspender cuentas, preservar evidencia y cooperar con autoridades cuando corresponda."
  ]],
