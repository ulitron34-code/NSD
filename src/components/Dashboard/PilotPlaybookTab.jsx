...
const pilotTimeline = [
  ...
  ["Semana 2", "Carga y revision", "Solicitantes suben evidencia; NSD ejecuta checklist, IA, score y plan de subsanacion."],
...
const successMetrics = [
  ...
  ["Ingresos piloto", "Meta: 1-3 tickets", "Validar fee por expediente o servicios NSD IF pagados."],
...
const pilotRoles = [
  ...
  ["NSD IF", "Estructura expediente, revisa con IA, genera score, memo y plan de subsanacion."],
    ...
    <div>
      <section style={{ background: COLORS.white, border: `1px solid ${COLORS.border}`, borderRadius: "14px", padding: "1.6rem", marginBottom: "1.5rem", boxShadow: COLORS.shadowSm }}>
        ...
        <p style={{ color: COLORS.textMuted, maxWidth: "900px", lineHeight: 1.7 }}>
          {L("Esta vista define como validar NSD con una entidad financiera o aliado: participantes, calendario, metricas, entregables y criterios de exito.", "This view defines how to validate NSD with a financial institution or partner: participants, timeline, metrics, deliverables and success criteria.")}
        </p>
      </section>
