...
const storySteps = [
  ...
  ["3", "Preparacion NSD IF", "Convierte el caso en expediente, data room, score, memo y plan de subsanacion."],
  ["4", "Otorgante", "Filtra oportunidades, revisa data room, solicita informacion y registra interes."],
  ["5", "NSD Admin", "Monitorea actividad, conversion, ingresos, auditoria y calidad operativa."],
];
...
const revenueStreams = [
  ...
  ["Servicios NSD IF", "Business plan, modelo financiero, pitch deck, memo y preparacion institucional."],
    ...
    <div>
      <section style={{
        ...
        <h1 style={{ fontFamily: "'Playfair Display', serif", color: "white", fontSize: "clamp(2rem, 4vw, 3rem)", lineHeight: 1.05, marginBottom: "0.8rem" }}>
          {L("NSD convierte solicitudes financieras dispersas en expedientes institucionales revisables.", "NSD turns scattered financing requests into institution-ready review files.")}
        </h1>
        <p style={{ maxWidth: "880px", color: "rgba(255,255,255,0.78)", fontSize: "1rem", lineHeight: 1.75 }}>
          {L("La demo muestra el puente completo entre solicitantes, otorgantes y NSD IF: preparacion documental, IA, data room, score, requerimientos, trazabilidad y monetizacion.", "The demo shows the complete bridge between applicants, funders and NSD IF: document readiness, AI, data room, score, requests, traceability and monetization.")}
        </p>
      </section>
