...
export default function OperatingModelSection() {
  ...
  const flow = [
    ...
    [L("2. Matriz", "2. Matrix"), L("NSD IF cruza el tipo de proyecto contra requisitos documentales y cumplimiento esperado.", "NSD IF crosses project type against documentary requirements and expected compliance.")],
  ...
  const safeguards = [
    [L("No aprueba creditos", "Does not approve credit"), L("NSD IF organiza evidencia y reduce friccion; la decision final corresponde al otorgante.", "NSD IF organizes evidence and reduces friction; final decision is the funder's responsibility.")],
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ maxWidth: "840px", marginBottom: "2rem" }}>
          <p style={{ color: COLORS.gold, letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 900, fontSize: "0.75rem", marginBottom: "0.65rem" }}>
            {L("Modelo operativo NSD IF", "NSD IF Operating Model")}
          </p>
