...
| Admin | Yes | Operations/config/security/AI split | Local readiness, incident controls, audit package, grantor document readiness, admin evidence coverage and read-only backend controls mounted | No |
