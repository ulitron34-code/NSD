...
| Backend persistence contracts | N/A | NUXERA state contract over existing service orders/documents/audit | Applicant checklist state and owner evidence-link skeletons implemented; SQL not applied | N/A |
