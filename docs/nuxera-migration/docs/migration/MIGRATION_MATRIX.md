...
| Backend persistence contracts | N/A | NUXERA state contract over existing service orders/documents/audit | Applicant checklist state skeleton and route coverage implemented; SQL not applied | N/A |
